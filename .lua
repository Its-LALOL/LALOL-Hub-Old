...
local a=''
for i,v in ipairs({10972284553,10710676163,4522347649,5023687570,286090429,6708206173}) do if game.PlaceId==v then a=game:HttpGet('https://raw.githubusercontent.com/Its-LALOL/LALOL-Hub/main/'..tostring(game.PlaceId)..'/.lua') end end
